...
const bar3Segments = 24

// Bar3 is Bar2 with a daily peak marker line ("trip" = daily).
type Bar3 struct {
	widget.BaseWidget
...
func NewBar3(cfg model.GaugeConfig) model.Widget {
	...
	b.smoothCount = 1
	b.peakValue = b.value
	b.peakDay = time.Now().Format("2006-01-02")
	b.ExtendBaseWidget(b)
	return b
}

func (b *Bar3) Style() string { return "bar3" }

func (b *Bar3) Config() model.GaugeConfig { return b.config }

func (b *Bar3) Value() float64 { return b.value }

func (b *Bar3) SetValue(v float64) {
...
func (b *Bar3) smooth(v float64) float64 {
...
func (b *Bar3) updatePeakDaily(v float64) {
...
func (b *Bar3) Snapshot() model.Snapshot {
	v := b.Value()
...
func (b *Bar3) CreateRenderer() fyne.WidgetRenderer {
	...
	peak := canvas.NewRectangle(parseHex(b.config.Theme.Danger, color.NRGBA{R: 255, G: 48, B: 48, A: 255}))
	peak.CornerRadius = 2
...
func (r *bar3Renderer) MinSize() fyne.Size { return fyne.NewSize(420, 120) }
...
func (r *bar3Renderer) Objects() []fyne.CanvasObject {
	...
	objs = append(objs, r.peak, r.marker)
	return objs
}
