...
- Added v3.4.10 dashboard CLI planning docs for `GoDriveLog dashboard` subcommands covering runtime, harness, examples, validation, config discovery using the asset-search ordering concept, compact config overview with vehicle data-source type, and gauge-aware harness sweep behaviour.
