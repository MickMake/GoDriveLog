...
Status: v3.6.3 radial pointer marker rendering complete; v3.6.4 pending

Current target: v3.6.4 bar pointer marker rendering

Current branch: `v3.6.3-radial-pointer-marker-rendering`
