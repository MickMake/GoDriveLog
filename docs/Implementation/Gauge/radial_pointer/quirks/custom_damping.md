# Custom radial damping quirk implementation
...
| Paired custom quirk design | `docs/Designs/Gauge/radial_pointer/quirks/custom_damping.md` |
...
This implementation record is intentionally narrow. It documents the existing `radial` support for `realism.damping` only.
