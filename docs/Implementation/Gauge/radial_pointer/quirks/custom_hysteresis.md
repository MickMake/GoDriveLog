# Custom radial hysteresis quirk implementation
...
| Paired custom quirk design | `docs/Designs/Gauge/radial_pointer/quirks/custom_hysteresis.md` |
...
This implementation record is intentionally narrow. It documents the existing `radial` support for `realism.hysteresis` only.
